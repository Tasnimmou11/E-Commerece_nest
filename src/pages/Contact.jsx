...
const Contact = () => {
  ...
  <div className='container'>
           <h1 className="font-bold text-lg md:text-2xl text-brand pt-12 pb-5">How can help you?</h1>
       <div className='flex flex-col md:flex-row gap-6'>
         <div className='lg:w-[400px]'>
            <h1 className='font-bold text-4xl md:text-5xl text-primary'>Let us know how we can help you</h1>
...
leo.</p>
    <p className=' font-normal text-base  pb-3 md:pb-8 text-secondary'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut
elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus
leo.</p>
        </div>
        <div  className='md:w-[400px]'>
            <h1 className='font-bold text-xl text-primary pt-3 md:pt-10'>01. Visit Feedback</h1>
            <p className=' w font-normal text-base  text-secondary py-5'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut
elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus
leo.</p>
    <h1 className='font-bold text-xl text-primary pb-3 md:pb-5'>02. Billing Inquiries</h1>
...
leo.</p>
        ...
        <div  className=' w-fit md:w-[400px]'> 
             <h1 className='font-bold text-xl text-primary pt-3 md:pt-10'>03. Employer Services</h1>
    ...
    <div className="md:max-w-[890px] w-fit  md:pl-36 py-15   ">
      ...
      <form className='grid grid-cols-2  gap-2 md:gap-4'>
        <div className="mb-2">
          ...
          <input
          className="w-full px-4 py-2 bg-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-yellow-300 transition duration-300"
        ...
        <div className="mb-2">
          ...
          <input
            className="w-full px-4 py-2 bg-gray-200 text-sm rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-200 transition duration-300"
        ...
        <div className="mb-2">
          <label className="block text-gray-800 mb-1" htmlFor="phone">Phone no</label>
          <input
          className="w-full px-4 py-2 bg-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-gray-200 transition duration-300"
        ...
        <div className="mb-2">
          ...
          <input
            className="w-full px-4 py-2 bg-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-gray-200transition duration-300"
        ...
        <div>
          ...
          <label className="block text-gray-800 mb-1" htmlFor="message"
            >Your Message</label>
          <textarea
            className="w-fit md:w-96 px-4 py-2 bg-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-200 transition duration-300"
            rows="4"
